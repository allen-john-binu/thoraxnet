...
def full_process():
    ...
    np.save('/workstation/seenia/autocontouring/Thoracic_Autocontouring/data/TestCases/LCTSC-Test-S3-204/04-17-2005-CHESTWALL-24743/1.000000-.simplified-46656/mask.npy',final_mask) 
    ...
    rtstruct.save(opt.dest+'predicted')
    print('Successfully saved predicted masks')
    
if __name__ == '__main__':
    parser = argparse.ArgumentParser()
    parser.add_argument('--source', type=str, default= '/workstation/seenia/autocontouring/Thoracic_Autocontouring/data/TestCases/LCTSC-Test-S3-204/04-17-2005-CHESTWALL-24743/1.000000-28825', help='path to dicom series')  
    ...
    parser.add_argument('--dest', type=str, default='/workstation/seenia/autocontouring/Thoracic_Autocontouring/data/TestCases/LCTSC-Test-S3-204/04-17-2005-CHESTWALL-24743/1.000000-.simplified-46656/', help='path to destination')
